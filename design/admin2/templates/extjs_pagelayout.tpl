...
<html lang="{$site.http_equiv.Content-language|wash}">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{'stylesheets/ext-theme-neptune-all-debug.css'|ezdesign('no')|ezurl('no','full')|mfurl()}" media="screen" />
        <script type="text/javascript" src={concat('javascript/bootstrap.js')|ezdesign}></script>
